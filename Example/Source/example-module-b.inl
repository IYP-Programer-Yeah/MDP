...
public:
	...
	template <typename T>
	static auto process_message(const T &messenger, const std::string &message) -> std::tuple<>
	{
		Report report;
	...
	template <typename T>
	static auto process_message(const T &messenger, const Report &message) -> std::tuple<>
	{
